...
//import  com.example.tracker.google.listscreen.MyAdapter.Companion.USERNAME_KEY
...
class UserProfile : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.google_fragment_user_profile, container, false)
